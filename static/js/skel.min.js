...
var skel = function() {
    ...
    var t = {
        ...
        trigger: function(e) {
            if (t.events[e] && 0 != t.events[e].length) return t.iterate(t.events[e], function(n) {
                t.events[e][n]()
            }), t
        },
        ...
        attach: function(e) {
            var n = t.obj.head,
                i = e.element;
            return (!i.parentNode || !i.parentNode.tagName) && (t._attach || (t._attach = n.firstChild), n.insertBefore(i, t._attach.nextSibling), e.permanent && (t._attach = i), !0)
        },
        ...
        initMethods: function() {
            document.addEventListener ? ! function(e, n) {
                ...
                for (a < 0 && (a = i - Math.abs(a)), n = a; n < i; n++)
                ...
                return !(null !== r["min-width"] && s < r["min-width"] || null !== r["max-width"] && s > r["max-width"] || null !== r["min-height"] && c < r["min-height"] || null !== r["max-height"] && c > r["max-height"])
        ...
        initVars: function() {
            ...
            e = "other", n = 0, i = [
                ...
                if (a.match(i[1])) return e = i[0], n = parseFloat(RegExp.$1), !1
                ...
                if (a.match(i[1])) return e = i[0], n = parseFloat(i[2] ? i[2](RegExp.$1) : RegExp.$1), !1
